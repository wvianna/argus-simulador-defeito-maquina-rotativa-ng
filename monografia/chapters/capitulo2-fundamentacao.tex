...
\bottomrule
\end{tabular}
\par\vspace{2pt}{\footnotesize Fonte: diretrizes técnicas do projeto (docs/descricao.txt).}
\end{table}
...
\bottomrule
\end{tabular}
\par\vspace{2pt}{\footnotesize Fonte: SPECIFICATION.md do projeto; docs/assinaturas\_fft\_falhas\_maquinas\_rotativas\_IA.md.}
\end{table}
...
enquanto folgas móveis ou de mancal geram uma \texttt{}floresta'' de harmônicos
...
coincide com uma frequência natural do sistema e \texttt{}trava'' nela, ocorre o
